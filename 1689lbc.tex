...
\href{/}{Click here to go back to the homepage.}

\maketitle

\chapter*{PERSONAL NOTE}
With the definite exceptions of both \emph{\hyperref[ch-eff-cal-3]{ch. 10, par. 3}} and \emph{ch. \hyperref[ch-chu-4]{26.4b}} (only because I reject the premise on which the conclusion is justified, not the conclusion itself); and arguably excepting one or more of \emph{\hyperref[ch-ords-2]{28.2}}, as well as arguably \emph{\hyperref[ch-lor-sup-3]{30.3},\hyperref[ch-lor-sup-8]{8}}, the following statement (confession) of faith is representative of a lot of the things that I essentially, personally believe about the Christian faith.}
\par
