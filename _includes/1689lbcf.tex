...
\emph{With the definite exceptions of \hyperref[par-el-in]{ch. 10, par. 3}; ch. \hyperref[par-pop-rom]{26.4b} (only because I reject the premise on which the conclusion is justified, not the conclusion itself), marked with prefix [!]; and arguably excepting \hyperref[par-apt-ords]{28.2}, as well as arguably \hyperref[par-min-admin]{30.3},\hyperref[par-ign-ung-part-admit]{8}, marked with prefix [?], the following statement (confession) of faith is representative of a lot of the things that I essentially, personally believe about the Christian faith.}
\par
